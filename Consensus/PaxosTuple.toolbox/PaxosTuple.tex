...
\@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} Integers ,\, Sets}%
...
\@pvspace{8.0pt}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}\@s{145.19} \.{\land} \A\, Q1
 ,\, Q2 \.{\in} Quorum \.{:} Q1 \.{\cap} Q2 \.{\neq} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} Ballot \.{\defeq}\@s{4.1}
 Nat}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} None \.{\defeq} {\CHOOSE} v
 \.{:} v \.{\notin} Ballot}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} Message \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{28.7} \{\@w{1a}
 \}\@s{0.36} \.{\times} Ballot}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{8.2} \.{\cup}\@s{9.38}
 \{\@w{1b} \} \.{\times} Acceptor \.{\times} Ballot \.{\times} ( Ballot
 \.{\cup} \{ \.{-} 1 \} ) \.{\times} ( Value \.{\cup} \{ None \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{8.2} \.{\cup}\@s{9.38}
 \{\@w{2a} \}\@s{0.36} \.{\times} Ballot \.{\times} Value}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{8.2} \.{\cup}\@s{9.38}
 \{\@w{2b} \} \.{\times} Acceptor \.{\times} Ballot \.{\times} Value}%
\@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} {\VARIABLE} maxBal ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{46.84} maxVBal ,\,}%
\@y{\@s{0}%
 \ensuremath{{\langle}maxVBal[a],\, maxVal[a]{\rangle}}: the vote with the
 largest ballot number cast by a;
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{46.84} maxVal
 ,\,\@s{7.80}}%
\@y{\@s{0}%
 it is \ensuremath{{\langle}\.{-}1,\, None{\rangle}} if a has not cast any
 vote.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{46.84} msgs}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} Send ( m ) \.{\defeq} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} vars \.{\defeq} {\langle}
 maxBal ,\, maxVBal ,\, maxVal ,\, msgs {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} TypeOK \.{\defeq} \.{\land}
 maxBal \.{\in} [ Acceptor \.{\rightarrow} Ballot \.{\cup} \{ \.{-} 1 \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{56.14} \.{\land} maxVBal
 \.{\in} [ Acceptor \.{\rightarrow} Ballot \.{\cup} \{ \.{-} 1 \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{56.14} \.{\land} maxVal
 \.{\in} [ Acceptor \.{\rightarrow} Value \.{\cup} \{ None \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{56.14} \.{\land} msgs
 \.{\subseteq} Message}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}}\midbar\@xx{}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{35.70} \.{\land} maxVBal
 \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{35.70} \.{\land} maxVal
 \.{=} [ a \.{\in} Acceptor \.{\mapsto} None ]}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{35.70} \.{\land} msgs
 \.{=} \{ \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} Phase1a ( b ) \.{\defeq}
 \.{\land} Send ( {\langle}\@w{1a} ,\, b {\rangle} )}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{69.22} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxVBal ,\, maxVal {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} Phase1b ( a ) \.{\defeq}
 \.{\land} \E\, m \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{84.43} \.{\land} m [ 1 ]
 \.{=}\@w{1a}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{84.43} \.{\land} m [ 2 ]
 \.{>} maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{84.43} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m [ 2 ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{84.43} \.{\land} Send (
 {\langle}\@w{1b} ,\, a ,\, m [ 2 ] ,\, maxVBal [ a ] ,\, maxVal [ a ]
 {\rangle} )}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{69.22} \.{\land}
 {\UNCHANGED} {\langle} maxVBal ,\, maxVal {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} Phase2a ( b ,\, v )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{8.2} \.{\land} {\lnot}
 \E\, m \.{\in} msgs\@s{7.89} \.{:} m [ 1 ] \.{=}\@w{2a} \.{\land} m [ 3 ]
 \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{8.2} \.{\land} \E\, Q
 \.{\in} Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{26.53} \.{\LET} Q1b
 \.{\defeq} \{ m \.{\in} msgs\@s{6.20} \.{:} \.{\land} m [ 1 ] \.{=}\@w{1b}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{148.25} \.{\land} m [ 2 ]
 \.{\in} Q}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{148.25} \.{\land} m [ 3 ]
 \.{=} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{51.03} Q1bv \.{\defeq} \{
 m \.{\in} Q1b \.{:} m [ 4 ] \.{\geq} 0 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{26.53} \.{\IN}\@s{4.09}
 \.{\land} \A\, a \.{\in} Q \.{:} \E\, m \.{\in} Q1b \.{:} m [ 2 ] \.{=} a}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@s{51.03} \.{\land} \.{\lor}
 Q1bv \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{62.14} \.{\lor} \E\,
 m\@s{7.71} \.{\in} Q1bv \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{81.45} \.{\land} m [ 5 ]
 \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{81.45} \.{\land} \A\, mm
 \.{\in} Q1bv \.{:} m [ 4 ] \.{\geq} mm [ 4 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{8.2} \.{\land} Send (
 {\langle}\@w{2a} ,\, b ,\, v {\rangle} )}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{8.2} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxVBal ,\, maxVal {\rangle}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}} Phase2b ( a ) \.{\defeq}
 \E\, m \.{\in} msgs \.{:} \.{\land} m [ 1 ] \.{=}\@w{2a}}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{128.83} \.{\land} m [ 2 ]
 \.{\geq} maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{128.83} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m [ 2 ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@s{128.83} \.{\land} maxVBal
 \.{'} \.{=} [ maxVBal {\EXCEPT} {\bang} [ a ] \.{=} m [ 2 ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{128.83} \.{\land} maxVal
 \.{'} \.{=} [ maxVal {\EXCEPT} {\bang} [ a ] \.{=} m [ 3 ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{128.83} \.{\land} Send (
 {\langle}\@w{2b} ,\, a ,\, m [ 2 ] ,\, m [ 3 ] {\rangle} )}%
\@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} Next \.{\defeq} \.{\lor}
 \E\, b\@s{0.64} \.{\in} Ballot \.{:} \.{\lor} Phase1a ( b )}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{112.86} \.{\lor} \E\, v
 \.{\in} Value \.{:} Phase2a ( b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{39.83} \.{\lor} \E\, a
 \.{\in} Acceptor \.{:} Phase1b ( a ) \.{\lor} Phase2b ( a )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} votes \.{\defeq} [ a \.{\in}
 Acceptor \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{48.30} \{ {\langle} m [ 3
 ] ,\, m [ 4 ] {\rangle} \.{:} m \.{\in} \{ mm \.{\in} msgs \.{:} \.{\land}
 mm [ 1 ] \.{=}\@w{2b}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{202.37} \.{\land} mm [ 2
 ] \.{=} a \} \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}} V \.{\defeq} {\INSTANCE}
 Voting}%
\@pvspace{8.0pt}%
