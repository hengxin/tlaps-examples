...
\setboolean{shading}{true}
 ...
 {\MODULE} PaxosTuple}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 This is a specification of the \ensuremath{Paxos} algorithm without explicit
 leaders
 or learners. It refines the spec in \ensuremath{Voting
 } \ensuremath{NB}: This specification was written before \ensuremath{TLAPS}
 had any support for
 records and therefore uses tuples for representing messages.
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} {\EXTENDS} Integers ,\, Sets}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}}\midbar\@xx{}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The constant parameters and the set Ballots are the same as in
 \ensuremath{Voting}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\CONSTANT} Value ,\,
 Acceptor ,\, Quorum}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} {\ASSUME} QuorumAssumption
 \.{\defeq} \.{\land} \A\, Q \.{\in} Quorum \.{:} Q \.{\subseteq} Acceptor}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{145.19} \.{\land} \A\, Q1
 ,\, Q2 \.{\in} Quorum \.{:} Q1 \.{\cap} Q2 \.{\neq} \{ \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Ballot \.{\defeq}\@s{4.1}
 Nat}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\end{lcom}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}} Message \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{28.7} \{\@w{1a}
 \}\@s{0.36} \.{\times} Ballot}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{8.2} \.{\cup}\@s{9.38}
 \{\@w{1b} \} \.{\times} Acceptor \.{\times} Ballot \.{\times} ( Ballot
 \.{\cup} \{ \.{-} 1 \} ) \.{\times} ( Value \.{\cup} \{ None \} )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{8.2} \.{\cup}\@s{9.38}
 \{\@w{2a} \}\@s{0.36} \.{\times} Ballot \.{\times} Value}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{8.2} \.{\cup}\@s{9.38}
 \{\@w{2b} \} \.{\times} Acceptor \.{\times} Ballot \.{\times} Value}%
\@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} {\VARIABLE} maxBal ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{46.84} maxVBal ,\,}%
\@y{\@s{0}%
 \ensuremath{{\langle}maxVBal[a],\, maxVal[a]{\rangle}} is the vote with the
 largest
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{46.84} maxVal
 ,\,\@s{12.29}}%
\@y{\@s{0}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{98.54}}%
\@y{\@s{0}%
 a has not cast any vote.
}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@s{46.84} msgs\@s{16.4}}%
\@y{\@s{0}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}} TypeOK \.{\defeq} \.{\land}
 maxBal \.{\in} [ Acceptor \.{\rightarrow} Ballot \.{\cup} \{ \.{-} 1 \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{56.14} \.{\land} maxVBal
 \.{\in} [ Acceptor \.{\rightarrow} Ballot \.{\cup} \{ \.{-} 1 \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{56.14} \.{\land} maxVal
 \.{\in} [ Acceptor \.{\rightarrow} Value \.{\cup} \{ None \} ]}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{56.14} \.{\land} msgs
 \.{\subseteq} Message}%
\@pvspace{16.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}} Init \.{\defeq} \.{\land}
 maxBal \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{35.70} \.{\land} maxVBal
 \.{=} [ a \.{\in} Acceptor \.{\mapsto} \.{-} 1 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{35.70} \.{\land} maxVal
 \.{=} [ a \.{\in} Acceptor \.{\mapsto} None ]}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@s{35.70} \.{\land} msgs
 \.{=} \{ \}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}} Send ( m ) \.{\defeq} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m \}}%
\@pvspace{16.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}} Phase1a ( b ) \.{\defeq}
 \.{\land} Send ( {\langle}\@w{1a} ,\, b {\rangle} )}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{69.22} \.{\land}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}} Phase1b ( a ) \.{\defeq}
 \.{\land} \E\, m \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{84.43} \.{\land} m [ 1 ]
 \.{=}\@w{1a}}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{84.43} \.{\land} m [ 2 ]
 \.{>} maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{84.43} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m [ 2 ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{84.43} \.{\land} Send (
 {\langle}\@w{1b} ,\, a ,\, m [ 2 ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{125.31} maxVBal [ a ]
 ,\, maxVal [ a ] {\rangle} )}%
 \@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{69.22} \.{\land}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 conditions are satisfied: (\ensuremath{i}) it has not already performed a
 phase \ensuremath{2a
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}} Phase2a ( b ,\, v )
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@s{8.2} \.{\land} {\lnot}
 \E\, m \.{\in} msgs\@s{7.89} \.{:} m [ 1 ] \.{=}\@w{2a} \.{\land} m [ 3 ]
 \.{=} b}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{8.2} \.{\land} \E\, Q
 \.{\in} Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@s{26.53} \.{\LET} Q1b
 \.{\defeq} \{ m \.{\in} msgs\@s{6.20} \.{:} \.{\land} m [ 1 ] \.{=}\@w{1b}}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{148.25} \.{\land} m [ 2
 ] \.{\in} Q}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@s{148.25} \.{\land} m [ 3
 ] \.{=} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@s{51.03} Q1bv \.{\defeq}
 \{ m \.{\in} Q1b \.{:} m [ 4 ] \.{\geq} 0 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}\@s{26.53} \.{\IN}\@s{4.09}
 \.{\land} \A\, a \.{\in} Q \.{:} \E\, m \.{\in} Q1b \.{:} m [ 2 ] \.{=} a}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{51.03} \.{\land}
 \.{\lor} Q1bv \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{62.14} \.{\lor} \E\,
 m\@s{7.71} \.{\in} Q1bv \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{81.45} \.{\land} m [ 5 ]
 \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{81.45} \.{\land} \A\, mm
 \.{\in} Q1bv \.{:} m [ 4 ] \.{\geq} mm [ 4 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{8.2} \.{\land} Send (
 {\langle}\@w{2a} ,\, b ,\, v {\rangle} )}%
 \@x{\makebox[0pt][r]{\scriptsize 143\hspace{1em}}\@s{8.2} \.{\land}
 {\UNCHANGED} {\langle} maxBal ,\, maxVBal ,\, maxVal {\rangle}}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 message,
 setting \ensuremath{maxBVal[a]} and \ensuremath{maxVal[a]} to record that
 vote and sending a
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 154\hspace{1em}} Phase2b ( a ) \.{\defeq}
 \E\, m \.{\in} msgs \.{:} \.{\land} m [ 1 ] \.{=}\@w{2a}}%
 \@x{\makebox[0pt][r]{\scriptsize 155\hspace{1em}}\@s{128.83} \.{\land} m [ 2
 ] \.{\geq} maxBal [ a ]}%
 \@x{\makebox[0pt][r]{\scriptsize 156\hspace{1em}}\@s{128.83} \.{\land} maxBal
 \.{'} \.{=} [ maxBal {\EXCEPT} {\bang} [ a ] \.{=} m [ 2 ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 157\hspace{1em}}\@s{128.83} \.{\land}
 maxVBal \.{'} \.{=} [ maxVBal {\EXCEPT} {\bang} [ a ] \.{=} m [ 2 ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 158\hspace{1em}}\@s{128.83} \.{\land} maxVal
 \.{'} \.{=} [ maxVal {\EXCEPT} {\bang} [ a ] \.{=} m [ 3 ] ]}%
 \@x{\makebox[0pt][r]{\scriptsize 159\hspace{1em}}\@s{128.83} \.{\land} Send (
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 170\hspace{1em}} Next \.{\defeq} \.{\lor}
 \E\, b\@s{0.64} \.{\in} Ballot \.{:} \.{\lor} Phase1a ( b )}%
 \@x{\makebox[0pt][r]{\scriptsize 171\hspace{1em}}\@s{112.86} \.{\lor} \E\, v
 \.{\in} Value \.{:} Phase2a ( b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}}\@s{39.83} \.{\lor} \E\, a
 \.{\in} Acceptor \.{:} Phase1b ( a ) \.{\lor} Phase2b ( a )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 174\hspace{1em}} Spec\@s{1.46} \.{\defeq}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 186\hspace{1em}} votes \.{\defeq} [ a
 \.{\in} Acceptor \.{\mapsto}}%
 \@x{\makebox[0pt][r]{\scriptsize 187\hspace{1em}}\@s{48.30} \{ {\langle} m [
 3 ] ,\, m [ 4 ] {\rangle} \.{:} m \.{\in} \{ mm \.{\in} msgs \.{:} \.{\land}
 mm [ 1 ] \.{=}\@w{2b}}%
 \@x{\makebox[0pt][r]{\scriptsize 188\hspace{1em}}\@s{202.37} \.{\land} mm [ 2
 ] \.{=} a \} \} ]}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 corresponding
 constants of that module \ensuremath{Voting}, and substituting the variable
 \ensuremath{maxBal
 } and the defined state function \ensuremath{votes} for the
 correspondingly-named
 variables of module \ensuremath{Voting}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 196\hspace{1em}} V \.{\defeq} {\INSTANCE}
 Voting}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 198\hspace{1em}} {\THEOREM} Spec
 \.{\implies} V {\bang} Spec}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 218\hspace{1em}}}\bottombar\@xx{}%
\end{document}
