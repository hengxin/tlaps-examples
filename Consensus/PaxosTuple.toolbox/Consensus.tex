...
\@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}}}\midbar\@xx{}%
 ...
 chosen \.{=} \{ \}}%
\@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} Next \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{16.4} \.{\land} chosen
 \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} \.{\land} \E\, v
 \.{\in} Value \.{:} chosen \.{'} \.{=} \{ v \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}} Spec \.{\defeq} Init
 \.{\land} {\Box} [ Next ]_{ chosen}}%
\@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}} Inv \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{15.15} \.{\land} chosen
 \.{\subseteq} Value}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{15.15} \.{\land}
 IsFiniteSet ( chosen )}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{15.15} \.{\land}
 Cardinality ( chosen ) \.{\leq} 1}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}} {\THEOREM} Invariance
 \.{\defeq} Spec \.{\implies} {\Box} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@pfstepnum{1}{1}\  Init
 \.{\implies} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{8.2} {\BY}
 CardinalityZero ,\, SMT {\DEFS} Init ,\, Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@pfstepnum{1}{2.}\  Inv
 \.{\land} [ Next ]_{ chosen} \.{\implies} Inv \.{'}}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{8.2} {\BY} CardinalityOne
 ,\, SMT {\DEFS} Next ,\, Inv}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@pfstepnum{1}{3}\  {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{8.2} {\PROOF}
