...
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}}\midbar\@xx{}%
 ...
 Quorum \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{27.72} \A\, a\@s{18.64}
 \.{\in} Q \.{:} VotedFor ( a ,\, b ,\, v )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}} chosen \.{\defeq} \{ v
...
\@pvspace{8.0pt}%
 ...
 \.{\dotdot} ( b \.{-} 1 ) \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{27.72}
 NoneOtherChoosableAt ( c ,\, v )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} VotesSafe \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@s{16.4} \A\, a \.{\in}
 Acceptor ,\, b \.{\in} Ballot ,\, v \.{\in} Value \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@s{27.72} VotedFor ( a ,\, b
 ,\, v ) \.{\implies} SafeAt ( b ,\, v )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}} OneVote \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{16.4} \A\, a \.{\in}
 Acceptor ,\, b \.{\in} Ballot ,\, v ,\, w \.{\in} Value \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@s{27.72} VotedFor ( a ,\, b
...
\ensuremath{\@pfstepnum{1}{1.}} \ensuremath{{\SUFFICES}}}%
 \ensuremath{{\ASSUME}} \ensuremath{{\NEW}} \ensuremath{v \.{\in} Value},
 \ensuremath{v \.{\in} chosen
 } \ensuremath{{\PROVE}} \ensuremath{\E\, u \.{\in} Value} :
 \ensuremath{chosen \.{=} \{u\}
}%
\end{cpar}%
\end{lcom}%
...
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}} {\THEOREM} ShowsSafety
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{55.02} TypeOK \.{\land}
 VotesSafe \.{\land} OneValuePerBallot \.{\implies}}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{67.32} \A\, Q \.{\in}
 Quorum ,\, b \.{\in} Ballot ,\, v \.{\in} Value \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@s{75.52} ShowsSafeAt ( Q
 ,\, b ,\, v ) \.{\implies} SafeAt ( b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{8.2} {\BY}
 QuorumAssumption ,\, Z3}%
 \@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}\@s{8.2} {\DEFS} Ballot ,\,
 TypeOK ,\, VotesSafe ,\, OneValuePerBallot ,\, SafeAt ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}}\@s{16.4} ShowsSafeAt ,\,
 CannotVoteAt ,\, NoneOtherChoosableAt ,\, DidNotVoteAt}%
\@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}} {\THEOREM} Invariance
 \.{\defeq} Spec \.{\implies} {\Box} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@pfstepnum{1}{1.}\  Init
 \.{\implies} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{8.2} {\BY} SMT {\DEF}
 Init ,\, Inv ,\, VotesSafe ,\, VotedFor ,\, TypeOK ,\, VotesSafe ,\,
 OneValuePerBallot}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@pfstepnum{1}{2.}\ 
 {\ASSUME} Inv ,\, [ Next ]_{ {\langle} votes ,\, maxBal {\rangle}}}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@s{23.88} {\PROVE} Inv
 \.{'}}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}\@s{8.2}\@pfstepnum{2}{}\ 
 {\USE} {\DEF} Inv ,\, Ballot ,\, VotedFor ,\, VoteFor}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{8.2}\@pfstepnum{2}{1.}
 {\CASE} {\UNCHANGED} {\langle} votes ,\, maxBal {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{1}{2} ,\,\@pfstepnum{2}{1} ,\, IsaM (\@w{auto} )}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{16.4} {\DEFS}
 IncreaseMaxBal ,\, ShowsSafeAt ,\,}%
...
\@pvspace{8.0pt}%
 ...
 \@x{\makebox[0pt][r]{\scriptsize 159\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{2}{1} ,\, QuorumAssumption ,\, Z3\@s{8.2}}%
\@y{\@s{0}%
 \ensuremath{SMTT(10)} fails
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 160\hspace{1em}}\@s{16.4} {\DEF} Next ,\,
 Inv ,\, TypeOK ,\, IncreaseMaxBal ,\, chosen ,\, ChosenAt ,\, VotedFor ,\,
 Ballot ,\, VoteFor}%
 \@x{\makebox[0pt][r]{\scriptsize 161\hspace{1em}}\@s{8.2}\@pfstepnum{2}{3.}\ 
 chosen \.{'} \.{=} \{ \} \.{\lor} \E\, v \.{\in} Value \.{:} chosen \.{'}
 \.{=} \{ v \}}%
 \@x{\makebox[0pt][r]{\scriptsize 162\hspace{1em}}\@s{16.4}\@pfstepnum{3}{1.}\
 {\PICK} a \.{\in} Acceptor ,\, b \.{\in} Ballot \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 163\hspace{1em}}\@s{52.58} \.{\lor}
 IncreaseMaxBal ( a ,\, b )}%
 \@x{\makebox[0pt][r]{\scriptsize 164\hspace{1em}}\@s{52.58} \.{\lor} \E\, v
 \.{\in} Value \.{:} VoteFor ( a ,\, b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 165\hspace{1em}}\@s{24.59}
 {\BY}\@pfstepnum{2}{1}\  {\DEF} Next}%
 \@x{\makebox[0pt][r]{\scriptsize 166\hspace{1em}}\@s{16.4}\@pfstepnum{3}{2.}
 {\CASE} IncreaseMaxBal ( a ,\, b )}%
 \@x{\makebox[0pt][r]{\scriptsize 167\hspace{1em}}\@s{16.4}\@pfstepnum{3}{3.}
 {\CASE} \E\, v \.{\in} Value \.{:} VoteFor ( a ,\, b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 168\hspace{1em}}\@s{16.4}\@pfstepnum{3}{q.}\
 {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 169\hspace{1em}}\@s{24.59}
 {\BY}\@pfstepnum{3}{1} ,\,\@pfstepnum{3}{2} ,\,\@pfstepnum{3}{3} ,\, SMT}%
 \@x{\makebox[0pt][r]{\scriptsize 170\hspace{1em}}\@s{8.2}\@pfstepnum{2}{q.}\ 
 {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 171\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{2}{1} ,\,\@pfstepnum{2}{2} ,\,\@pfstepnum{2}{3} ,\,
 OneVoteThm ,\, VotesSafeImpliesConsistency ,\, SetExtensionality ,\, SMT}%
 \@x{\makebox[0pt][r]{\scriptsize 172\hspace{1em}}\@s{16.4} {\DEF} Inv ,\, C
 {\bang} Next}%
\@x{\makebox[0pt][r]{\scriptsize 173\hspace{1em}}\@pfstepnum{1}{3.}\  {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 174\hspace{1em}}\@s{8.2} {\PROOF}
 {\OMITTED}}%
\@x{\makebox[0pt][r]{\scriptsize 175\hspace{1em}}}\bottombar\@xx{}%
\end{document}
