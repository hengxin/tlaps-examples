...
\setboolean{shading}{true}
 ...
 {\MODULE} NaturalsInduction}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
...
\begin{cpar}{1}{F}{F}{0}{0}{}%
 The proofs of these theorems appear in module
 \ensuremath{NaturalsInduction}\ensuremath{\backslash}\_proofs.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} {\EXTENDS} Integers ,\,
 TLAPS}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The following is the simple statement of inductions over the naturals.
 For predicates \ensuremath{P} defined by a moderately complex operator, it
 is often
 useful to hide the operator definition before using this theorem. That
 is, you first define a suitable operator \ensuremath{P} (not necessarily by
 that
 name), prove the two hypotheses of the theorem, and then hide the
 definition of \ensuremath{P} when using the theorem.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} {\THEOREM} NatInduction
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{8.2} {\ASSUME} {\NEW} P (
 \_ ) ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{46.44} P ( 0 ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{46.44} \A\, n \.{\in} Nat
 \.{:} P ( n ) \.{\implies} P ( n \.{+} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{8.2} {\PROVE}\@s{4.1}
 \A\, n \.{\in} Nat \.{:} P ( n )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
A useful corollary of \ensuremath{NatInduction
}%
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}} {\THEOREM}
 DownwardNatInduction \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@s{8.2} {\ASSUME} {\NEW} P (
 \_ ) ,\, {\NEW} m \.{\in} Nat ,\, P ( m ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{46.44} \A\, n \.{\in} 1
 \.{\dotdot} m \.{:} P ( n ) \.{\implies} P ( n \.{-} 1 )}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{8.2} {\PROVE}\@s{4.1} P (
 0 )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}} {\THEOREM}
 GeneralNatInduction \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{55.02} {\ASSUME} {\NEW} P
 ( \_ ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{93.26} \A\, n \.{\in} Nat
 \.{:} ( \A\, m \.{\in} 0 \.{\dotdot} ( n \.{-} 1 ) \.{:} P ( m ) )
 \.{\implies} P ( n )}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{55.02} {\PROVE}\@s{4.1}
 \A\, n \.{\in} Nat \.{:} P ( n )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
The following theorem expresses the ``least-number principle'':
 if \ensuremath{P(n)} is true for some natural number \ensuremath{n} then
 there is a
 smallest natural number for which \ensuremath{P} is true. It could be
 derived in
 module \ensuremath{WellFoundedInduction} as a corollary of the fact that the
 natural
 numbers are well ordered, but we give a direct proof.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} {\THEOREM} SmallestNatural
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{8.2} {\ASSUME} {\NEW} P (
 \_ ) ,\, {\NEW} n \.{\in} Nat ,\, P ( n )}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{8.2} {\PROVE}\@s{4.1}
 \E\, m \.{\in} Nat \.{:} \.{\land} P ( m )}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{101.09} \.{\land} \A\, k
 \.{\in} 0 \.{\dotdot} m \.{-} 1 \.{:} {\lnot} P ( k )}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The following theorem says that a recursively defined function \ensuremath{f}
 over
 the natural numbers is well-defined if for every \ensuremath{n \.{\in} Nat}
 the
 definition of \ensuremath{f[n]} depends only on arguments smaller than
 \ensuremath{n}.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}} {\THEOREM} RecursiveFcnOfNat
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{8.2} {\ASSUME} {\NEW} Def
 ( \_ ,\, \_ ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{46.44} {\ASSUME} {\NEW} n
 \.{\in} Nat ,\, {\NEW} g ,\, {\NEW} h ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{84.68} \A\, i \.{\in} 0
 \.{\dotdot} ( n \.{-} 1 ) \.{:} g [ i ] \.{=} h [ i ]}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{46.44} {\PROVE}\@s{4.1}
 Def ( g ,\, n ) \.{=} Def ( h ,\, n )}%
 \@x{\makebox[0pt][r]{\scriptsize 73\hspace{1em}}\@s{8.2} {\PROVE}\@s{4.1}
 \.{\LET} f [ n \.{\in} Nat ] \.{\defeq} Def ( f ,\, n )}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}}\@s{46.44} \.{\IN} f \.{=} [
 n \.{\in} Nat \.{\mapsto} Def ( f ,\, n ) ]}%
\@pvspace{16.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 The following theorem \ensuremath{NatInductiveDef} is what you use to justify
 a
 function defined by primitive recursion over the naturals.
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}} NatInductiveDefHypothesis (
 f ,\, f0 ,\, Def ( \_ ,\, \_ ) ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}\@s{12.29} ( f \.{=}\@s{4.1}
 {\CHOOSE} g \.{:} g \.{=} [ i \.{\in} Nat \.{\mapsto} {\IF} i \.{=} 0
 \.{\THEN} f0 \.{\ELSE} Def ( g [ i \.{-} 1 ] ,\, i ) ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} NatInductiveDefConclusion (
 f ,\, f0 ,\, Def ( \_ ,\, \_ ) ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 84\hspace{1em}}\@s{20.5} f \.{=} [ i \.{\in}
 Nat \.{\mapsto} {\IF} i \.{=} 0 \.{\THEN} f0 \.{\ELSE} Def ( f [ i \.{-} 1 ]
 ,\, i ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}} {\THEOREM} NatInductiveDef
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{8.2} {\ASSUME} {\NEW} Def
 ( \_ ,\, \_ ) ,\, {\NEW} f ,\, {\NEW} f0 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{46.44}
 NatInductiveDefHypothesis ( f ,\, f0 ,\, Def )}%
 \@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{8.2} {\PROVE}\@s{4.1}
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}} {\THEOREM}
 RecursiveFcnOfNatType \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{8.2} {\ASSUME} {\NEW} f
 ,\, {\NEW} S ,\, {\NEW} Def ( \_ ,\, \_ ) ,\, f \.{=} [ n \.{\in} Nat
 \.{\mapsto} Def ( f ,\, n ) ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{46.44} {\ASSUME} {\NEW} n
 \.{\in} Nat ,\, {\NEW} g ,\, \A\, i \.{\in} 0 \.{\dotdot} n \.{-} 1 \.{:} g
 [ i ] \.{\in} S}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{46.44} {\PROVE}\@s{4.1}
 Def ( g ,\, n ) \.{\in} S}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{8.2} {\PROVE}\@s{4.1} f
 \.{\in} [ Nat \.{\rightarrow} S ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}} {\THEOREM}
 NatInductiveDefType \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{8.2} {\ASSUME} {\NEW}
 Def ( \_ ,\, \_ ) ,\, {\NEW} S ,\, {\NEW} f ,\, {\NEW} f0 \.{\in} S ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{46.44}
 NatInductiveDefConclusion ( f ,\, f0 ,\, Def ) ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{46.44} f0 \.{\in} S ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{46.44} \A\, v \.{\in} S
 ,\, n \.{\in} Nat \.{\,\backslash\,} \{ 0 \} \.{:} Def ( v ,\, n ) \.{\in}
 S}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{8.2} {\PROVE}\@s{4.1} f
 \.{\in} [ Nat \.{\rightarrow} S ]}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}} {\THEOREM}
 RecursiveFcnOfNatUnique \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@s{8.2} {\ASSUME} {\NEW}
 Def ( \_ ,\, \_ ) ,\, {\NEW} f ,\, {\NEW} g ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{46.44} f\@s{0.29} \.{=}
 [ n \.{\in} Nat \.{\mapsto} Def ( f ,\, n ) ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{46.44} g \.{=} [ n
 \.{\in} Nat \.{\mapsto} Def ( g ,\, n ) ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@s{46.44} {\ASSUME} {\NEW}
 n \.{\in} Nat ,\, {\NEW} ff ,\, {\NEW} gg ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@s{84.68} \A\, i \.{\in} 0
 \.{\dotdot} ( n \.{-} 1 ) \.{:} ff [ i ] \.{=} gg [ i ]}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{46.44} {\PROVE}\@s{4.1}
 Def ( ff ,\, n ) \.{=} Def ( gg ,\, n )}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{8.2} {\PROVE}\@s{4.1} f
 \.{=} g}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}} {\THEOREM}
 NatInductiveUnique \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{8.2} {\ASSUME} {\NEW}
 Def ( \_ ,\, \_ ) ,\, {\NEW} f ,\, {\NEW} g ,\, {\NEW} f0 ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{46.44}
 NatInductiveDefConclusion ( f ,\, f0 ,\, Def ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{46.44}
 NatInductiveDefConclusion ( g ,\, f0 ,\, Def )}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{8.2} {\PROVE}\@s{4.1} f
 \.{=} g}%
\@pvspace{8.0pt}%
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{lcom}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}
 FiniteNatInductiveDefHypothesis ( f ,\, c ,\, Def ( \_ ,\, \_ ) ,\, m ,\, n
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@s{12.29} ( f \.{=}\@s{4.1}
 {\CHOOSE} g \.{:} g \.{=} [ i \.{\in} m \.{\dotdot} n \.{\mapsto} {\IF} i
 \.{=} m \.{\THEN} c \.{\ELSE} Def ( g [ i \.{-} 1 ] ,\, i ) ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}
 FiniteNatInductiveDefConclusion ( f ,\, c ,\, Def ( \_ ,\, \_ ) ,\, m ,\, n
 ) \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@s{20.5} f \.{=} [ i
 \.{\in} m \.{\dotdot} n \.{\mapsto} {\IF} i \.{=} m \.{\THEN} c \.{\ELSE}
 Def ( f [ i \.{-} 1 ] ,\, i ) ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}} {\THEOREM}
 FiniteNatInductiveDef \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@s{8.2} {\ASSUME} {\NEW}
 Def ( \_ ,\, \_ ) ,\, {\NEW} f ,\, {\NEW} c ,\, {\NEW} m \.{\in} Nat ,\,
 {\NEW} n \.{\in} Nat ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{46.44}
 FiniteNatInductiveDefHypothesis ( f ,\, c ,\, Def ,\, m ,\, n )}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{8.2} {\PROVE}\@s{4.1}
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{(\.{*}} The following theorems are analogous to the preceding
 ones but for\@s{15.0}\ensuremath{\.{*})
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{(\.{*}} functions defined over intervals of natural
 numbers\ensuremath{.\@s{50.0}\.{*})
} (*************************************************************************** )
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{FiniteNatInductiveDefHypothesis(f,\, c,\, Def(\_,\,\_),\, m,\, n)
 \.{\defeq}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{7.5}{0}{}%
 (\ensuremath{f \.{=} {\CHOOSE} g} : \ensuremath{g \.{=}} [\ensuremath{i
 \.{\in} m\.{\dotdot}n \.{\mapsto} {\IF}} \ensuremath{i \.{=} m}
 \ensuremath{\.{\THEN} c} \ensuremath{\.{\ELSE} Def(g[i\.{-}1],\, i)}])
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
 \ensuremath{FiniteNatInductiveDefConclusion(f,\, c,\, Def(\_,\,\_),\, m,\, n)
 \.{\defeq}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{12.5}{0}{}%
 \ensuremath{f \.{=}} [\ensuremath{i \.{\in} m\.{\dotdot}n \.{\mapsto} {\IF}}
 \ensuremath{i \.{=} m} \ensuremath{\.{\THEN} c} \ensuremath{\.{\ELSE}
 Def(f[i\.{-}1],\, i)}]
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
\ensuremath{{\THEOREM}} \ensuremath{FiniteNatInductiveDef \.{\defeq}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
 \ensuremath{{\ASSUME}} \ensuremath{{\NEW}} \ensuremath{Def(\_,\,\_)},
 \ensuremath{{\NEW}} \ensuremath{f}, \ensuremath{{\NEW}} \ensuremath{c},
 \ensuremath{{\NEW}} \ensuremath{m \.{\in} Nat}, \ensuremath{{\NEW}}
 \ensuremath{n \.{\in} Nat},
\end{cpar}%
\begin{cpar}{0}{T}{F}{17.5}{0}{}%
\ensuremath{FiniteNatInductiveDefHypothesis(f,\, c,\, Def,\, m,\, n)
}%
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
 \ensuremath{{\PROVE}} \ensuremath{FiniteNatInductiveDefConclusion(f,\, c,\,
 Def,\, m,\, n)
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
\ensuremath{{\THEOREM}} \ensuremath{FiniteNatInductiveDefType \.{\defeq}
}%
\end{cpar}%
\begin{cpar}{0}{T}{T}{5.0}{2.5}{%
\ensuremath{{\ASSUME}}}%
 \ensuremath{{\NEW}} \ensuremath{S}, \ensuremath{{\NEW}}
 \ensuremath{Def(\_,\,\_)}, \ensuremath{{\NEW}} \ensuremath{f},
 \ensuremath{{\NEW}} \ensuremath{c \.{\in} S}, \ensuremath{{\NEW}}
 \ensuremath{m \.{\in} Nat}, \ensuremath{{\NEW}} \ensuremath{n \.{\in} Nat},
 \ensuremath{FiniteNatInductiveDefConclusion(f,\, c,\, Def,\, m,\, n)},
 \ensuremath{\A\, v \.{\in} S}, \ensuremath{i \.{\in}} (\ensuremath{m\.{+}1})
 \ensuremath{\.{\dotdot} n} : \ensuremath{Def(v,\,i) \.{\in} S
}%
\end{cpar}%
\begin{cpar}{1}{T}{F}{5.0}{0}{}%
 \ensuremath{{\PROVE}} \ensuremath{f \.{\in}} [\ensuremath{m\.{\dotdot}n
 \.{\rightarrow} S}]
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
\ensuremath{{\THEOREM}} \ensuremath{FiniteNatInductiveUnique \.{\defeq}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
 \ensuremath{{\ASSUME}} \ensuremath{{\NEW}} \ensuremath{Def(\_,\,\_)},
 \ensuremath{{\NEW}} \ensuremath{f}, \ensuremath{{\NEW}} \ensuremath{g},
 \ensuremath{{\NEW}} \ensuremath{c}, \ensuremath{{\NEW}} \ensuremath{m
 \.{\in} Nat}, \ensuremath{{\NEW}} \ensuremath{n \.{\in} Nat},
\end{cpar}%
\begin{cpar}{0}{T}{F}{17.5}{0}{}%
\ensuremath{FiniteNatInductiveDefConclusion(f,\, c,\, Def,\, m,\, n)},
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{FiniteNatInductiveDefConclusion(g,\, c,\, Def,\, m,\, n)
}%
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
\ensuremath{{\PROVE}} \ensuremath{f \.{=} g
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
(*************************************************************************** )
 \ensuremath{(\.{*}} The following example shows how this module is
 used\ensuremath{.\@s{50.0}\.{*})
} (*************************************************************************** )
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{factorial[n \.{\in} Nat] \.{\defeq} {\IF}} \ensuremath{n \.{=} 0}
 \ensuremath{\.{\THEN} 1} \ensuremath{\.{\ELSE} n \.{*} factorial[n\.{-}1]
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{{\THEOREM}} \ensuremath{FactorialDefConclusion \.{\defeq}
 NatInductiveDefConclusion(factorial,\, 1,\, {\LAMBDA}} \ensuremath{v,\,n
 \.{:} n\.{*}v)
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\@pfstepnum{1}{1.}}
 \ensuremath{NatInductiveDefHypothesis(factorial,\, 1,\, {\LAMBDA}}
 \ensuremath{v,\,n \.{:} n\.{*}v)
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
 \ensuremath{{\BY}} \ensuremath{{\DEF}}
 \ensuremath{NatInductiveDefHypothesis}, factorial
\end{cpar}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
\ensuremath{\@pfstepnum{1}{2.}} \ensuremath{{\QED}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
\ensuremath{{\BY}} \ensuremath{\@pfstepnum{1}{1}}, \ensuremath{NatInductiveDef
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{1}{F}{F}{0}{0}{}%
 \ensuremath{{\THEOREM}} \ensuremath{FactorialDef \.{\defeq} \A\, n \.{\in}
 Nat} : \ensuremath{factorial[n] \.{=} {\IF}} \ensuremath{n \.{=} 0}
 \ensuremath{\.{\THEN} 1} \ensuremath{\.{\ELSE} n \.{*} factorial[n\.{-}1]
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{{\BY}} \ensuremath{FactorialDefConclusion} \ensuremath{{\DEFS}}
 \ensuremath{NatInductiveDefConclusion
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{{\THEOREM}} \ensuremath{FactorialType \.{\defeq}} factorial
 \ensuremath{\.{\in}} [\ensuremath{Nat \.{\rightarrow} Nat}]
 \ensuremath{\@pfstepnum{1}{1.}} \ensuremath{\A\, v \.{\in} Nat},
 \ensuremath{n \.{\in} Nat \.{\,\backslash\,} \{0\}} : \ensuremath{n \.{*} v
 \.{\in} Nat
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
 \ensuremath{{\BY}} \ensuremath{\@pfstepnum{1}{1}}, \ensuremath{1 \.{\in}
 Nat}, \ensuremath{NatInductiveDefType}, \ensuremath{FactorialDefConclusion},
 \ensuremath{Isa
}%
\end{cpar}%
\vshade{5.0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 12:29:46 \ensuremath{CEST} 2014 by \ensuremath{merz
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified \ensuremath{Tue}
 \ensuremath{Oct} 15 12:06:48 \ensuremath{CEST} 2013 by \ensuremath{shaolin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified Sat \ensuremath{Nov} 26
 08:49:59 \ensuremath{CET} 2011 by \ensuremath{merz
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified \ensuremath{Mon}
 \ensuremath{Nov} 07 08:58:05 \ensuremath{PST} 2011 by \ensuremath{lamport
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Mon}
 \ensuremath{Oct} 31 02:52:05 \ensuremath{PDT} 2011 by \ensuremath{lamport
}%
\end{cpar}%
\end{lcom}%
\end{document}
