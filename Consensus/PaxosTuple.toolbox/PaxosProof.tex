...
\setboolean{shading}{true}
 ...
 {\MODULE} PaxosProof}\moduleRightDash\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} TLAPS ,\,
 PaxosTuple}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} WellFormedMessages \.{\defeq}
 \A\, m \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}}\@s{16.4} \.{\land} m [ 1 ]
 \.{=}\@w{1a}\@s{0.36} \.{\implies} m [ 2 ]\@s{13.13} \.{\in} Ballot}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}}\@s{16.4} \.{\land} m [ 1 ]
 \.{=}\@w{1b} \.{\implies} \.{\land} m [ 2 ] \.{\in} Acceptor}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}\@s{96.06} \.{\land} m [ 3 ]
 \.{\in} Ballot}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}}\@s{96.06} \.{\land} m [ 4 ]
 \.{\in} Ballot \.{\cup} \{ \.{-} 1 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}\@s{96.06} \.{\land} m [ 5 ]
 \.{\in} Value \.{\cup} \{ None \}}%
 \@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}\@s{16.4} \.{\land} m [ 1 ]
 \.{=}\@w{2a}\@s{0.36} \.{\implies} m [ 2 ] \.{\in} Ballot \.{\land} m [ 3 ]
 \.{\in} Value}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}}\@s{16.4} \.{\land} m [ 1 ]
 \.{=}\@w{2b} \.{\implies} m [ 2 ] \.{\in} Acceptor \.{\land} m [ 3 ] \.{\in}
 Ballot \.{\land} m [ 4 ] \.{\in} Value}%
\@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\THEOREM} WFmsgs \.{\defeq}
 TypeOK \.{\implies} WellFormedMessages}%
 \@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{8.2} {\BY} Z3 {\DEFS}
 Ballot ,\, TypeOK ,\, Message ,\, WellFormedMessages}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}} {\THEOREM} typing \.{\defeq}
 Spec \.{\implies} {\Box} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@pfstepnum{1}{} . {\USE}
 {\DEFS} Ballot ,\, TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@pfstepnum{1}{1.}\  Init
 \.{\implies} TypeOK}%
...
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}\@pfstepnum{1}{q.}\  {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}}\@s{8.2} {\BY}
 {\ONLY}\@pfstepnum{1}{1} ,\,\@pfstepnum{1}{2} ,\, typing ,\, PTL {\DEF}
 Spec}%
\@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} StructOK2 \.{\defeq} \A\, m
 \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{12.29} ( m [ 1 ]
 \.{=}\@w{1b} ) \.{\implies} \.{\land} maxBal [ m [ 2 ] ] \.{\geq} m [ 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{88.63} \.{\land} ( m [ 4
 ] \.{\geq} 0 ) \.{\implies} {\langle} m [ 4 ] ,\, m [ 5 ] {\rangle}\@s{8.45}
 \.{\in} votes [ m [ 2 ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}} StructOK3 \.{\defeq} \A\, m
 \.{\in} msgs \.{:} m [ 1 ] \.{=}\@w{2a}\@s{0.36} \.{\implies} \.{\land} \E\,
 Q \.{\in} Quorum \.{:} V {\bang} ShowsSafeAt ( Q ,\, m [ 2 ] ,\, m [ 3 ] )}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{195.31} \.{\land} \A\, mm
 \.{\in} msgs \.{:} \.{\land} mm [ 1 ]\@s{4.44} \.{=}\@w{2a}}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{274.21} \.{\land} mm [ 2
 ]\@s{4.44} \.{=} m [ 2 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{274.21} \.{\implies} mm [
 3 ] \.{=} m [ 3 ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}} StructOK4 \.{\defeq} \A\, m
 \.{\in} msgs \.{:} m [ 1 ] \.{=}\@w{2b} \.{\implies} \.{\land} \E\,
 mo\@s{3.20} \.{\in} msgs \.{:} \.{\land} mo [ 1 ]\@s{7.64} \.{=}\@w{2a}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{274.21} \.{\land} mo [ 2
 ]\@s{7.64} \.{=} m [ 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{274.21} \.{\land} mo [ 3
 ]\@s{7.64} \.{=} m [ 4 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{195.31} \.{\land} maxBal
 [ m [ 2 ] ] \.{\geq} m [ 3 ]}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{195.31} \.{\land} maxVBal
 [ m [ 2 ] ] \.{\geq} m [ 3 ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}} StructOK5 \.{\defeq} \A\, m
 \.{\in} msgs \.{:} m [ 1 ] \.{=}\@w{1b} \.{\implies} \A\, d \.{\in} Ballot
 \.{:} m [ 4 ] \.{<} d \.{\land} d \.{<} m [ 3 ] \.{\implies}}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{195.31} \A\, v\@s{0.46}
 \.{\in} Value \.{:} {\lnot} {\langle} d ,\, v {\rangle} \.{\in} votes [ m [
 2 ] ]}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}} StructOK \.{\defeq}
 \.{\land} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{62.14} \.{\land}
 StructOK1}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{62.14} \.{\land}
 StructOK2}%
\@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}}%
\@y{\@s{27.5}%
 \ensuremath{\.{\land} StructOK3
}}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{49.19} \.{\land}
 StructOK4}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{49.19} \.{\land}
 StructOK5}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}} {\THEOREM} struct\_lemma
 \.{\defeq} Spec \.{\implies} {\Box} StructOK}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@pfstepnum{1}{} . {\USE}
 {\DEFS} Ballot ,\, StructOK ,\, TypeOK ,\, StructOK1 ,\, StructOK2 ,\,
 StructOK4 ,\, StructOK5}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@pfstepnum{1}{1.}\  Init
 \.{\implies} StructOK}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{8.2} {\BY} Z3 {\DEFS}
 Init}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@pfstepnum{1}{2.}\  StructOK
 \.{\land} [ Next ]_{ vars} \.{\implies} StructOK \.{'}}%
\@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{8.2} {\PROOF} {\OMITTED}}%
\@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@pfstepnum{1}{3.}\  {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{8.2}
 {\BY}\@pfstepnum{1}{1} ,\,\@pfstepnum{1}{2} ,\, PTL {\DEF} Spec}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 74\hspace{1em}} {\THEOREM} Spec \.{\implies}
 {\Box} StructOK3}%
 \@x{\makebox[0pt][r]{\scriptsize 75\hspace{1em}}\@pfstepnum{1}{} . {\USE}
 {\DEFS} Ballot ,\, TypeOK ,\, StructOK3}%
 \@x{\makebox[0pt][r]{\scriptsize 76\hspace{1em}}\@pfstepnum{1}{1.}\  Init
 \.{\implies} StructOK3}%
 \@x{\makebox[0pt][r]{\scriptsize 77\hspace{1em}}\@s{8.2} {\BY} Z3 {\DEFS}
 Init}%
 \@x{\makebox[0pt][r]{\scriptsize 78\hspace{1em}}\@pfstepnum{1}{2.}\  TypeOK
 \.{\land} StructOK \.{\land} [ Next ]_{ vars} \.{\implies} StructOK3 \.{'}}%
\@x{\makebox[0pt][r]{\scriptsize 79\hspace{1em}}\@s{8.2} {\PROOF} {\OMITTED}}%
\@x{\makebox[0pt][r]{\scriptsize 80\hspace{1em}}\@pfstepnum{1}{3.}\  {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 81\hspace{1em}}\@s{8.2} {\BY}
 {\ONLY}\@pfstepnum{1}{1} ,\,\@pfstepnum{1}{2} ,\, struct\_lemma ,\, PTL
 {\DEF} Spec ,\, StructOK}%
\@x{\makebox[0pt][r]{\scriptsize 82\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 83\hspace{1em}} Inv \.{\defeq} TypeOK
 \.{\land} StructOK1 \.{\land} StructOK2 \.{\land} StructOK3 \.{\land}
 StructOK4 \.{\land} StructOK5}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 85\hspace{1em}} {\THEOREM} OtherMessage
 \.{\defeq} \A\, m1 ,\, m2 \.{\in} msgs \.{'} ,\, a ,\, b \.{\in} \{\@w{1a}
 ,\,\@w{2a} ,\,\@w{1b} ,\,\@w{2b} \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 86\hspace{1em}}\@s{75.52} \.{\land} m1 [ 1
 ]\@s{0.08} \.{=} a \.{\land} m2 [ 1 ] \.{=} b \.{\land} a \.{\neq} b}%
 \@x{\makebox[0pt][r]{\scriptsize 87\hspace{1em}}\@s{75.52} \.{\land} msgs
 \.{'} \.{=} msgs \.{\cup} \{ m2 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 88\hspace{1em}}\@s{75.52} \.{\implies} m1
 \.{\in} msgs}%
\@x{\makebox[0pt][r]{\scriptsize 89\hspace{1em}}\@s{8.2} {\BY} Z3}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 91\hspace{1em}} {\THEOREM} \A\, b \.{\in}
 Ballot ,\, v \.{\in} Value \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 92\hspace{1em}}\@s{58.14} Phase2a ( b ,\, v
 ) \.{\land} Inv \.{\implies} \E\, Q \.{\in} Quorum \.{:} V {\bang}
 ShowsSafeAt ( Q ,\, b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 93\hspace{1em}}\@pfstepnum{1}{1.}\ 
 {\SUFFICES} {\ASSUME} {\NEW} b\@s{0.44} \.{\in} Ballot ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 94\hspace{1em}}\@s{106.42} {\NEW} v \.{\in}
 Value ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 95\hspace{1em}}\@s{106.42} {\lnot} \E\, m
 \.{\in} msgs \.{:} m [ 1 ] \.{=}\@w{2a} \.{\land} m [ 3 ] \.{=} b ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 96\hspace{1em}}\@s{106.42} {\NEW} Q \.{\in}
 Quorum ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 97\hspace{1em}}\@s{106.42} \.{\LET}\@s{3.44}
 Q1b \.{\defeq} \{ m \.{\in} msgs\@s{2.76} \.{:} \.{\land} m [ 1 ]
 \.{=}\@w{1b}}%
 \@x{\makebox[0pt][r]{\scriptsize 98\hspace{1em}}\@s{228.14} \.{\land} m [ 2 ]
 \.{\in} Q}%
 \@x{\makebox[0pt][r]{\scriptsize 99\hspace{1em}}\@s{228.14} \.{\land} m [ 3 ]
 \.{=} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 100\hspace{1em}}\@s{130.92} Q1bv \.{\defeq}
 \{ m \.{\in} Q1b \.{:} m [ 4 ] \.{\geq} 0 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 101\hspace{1em}}\@s{106.42} \.{\IN}\@s{4.10}
 \.{\land} \A\, a \.{\in} Q \.{:} \E\, m \.{\in} Q1b \.{:} m [ 2 ] \.{=} a}%
 \@x{\makebox[0pt][r]{\scriptsize 102\hspace{1em}}\@s{130.92} \.{\land}
 \.{\lor} Q1bv \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 103\hspace{1em}}\@s{142.03} \.{\lor} \E\,
 m\@s{7.71} \.{\in} Q1bv \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 104\hspace{1em}}\@s{161.34} \.{\land} m [ 5
 ] \.{=} v}%
 \@x{\makebox[0pt][r]{\scriptsize 105\hspace{1em}}\@s{161.34} \.{\land} \A\,
 mm \.{\in} Q1bv \.{:} m [ 4 ] \.{\geq} mm [ 4 ] ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 106\hspace{1em}}\@s{106.42} Send (
 {\langle}\@w{2a} ,\, b ,\, v {\rangle} ) ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 107\hspace{1em}}\@s{106.42} {\UNCHANGED}
 {\langle} maxBal ,\, maxVBal ,\, maxVal {\rangle} ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 108\hspace{1em}}\@s{106.42} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 109\hspace{1em}}\@s{68.17} {\PROVE}\@s{4.1}
 V {\bang} ShowsSafeAt ( Q ,\, b ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 110\hspace{1em}}\@s{8.2} {\BY} SMT {\DEF}
 Phase2a}%
 \@x{\makebox[0pt][r]{\scriptsize 111\hspace{1em}}\@pfstepnum{1}{} .
 {\USE}\@pfstepnum{1}{1}\  {\DEF} Ballot ,\, Inv ,\, TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 112\hspace{1em}}\@pfstepnum{1}{2.}\  V
 {\bang} ShowsSafeAt ( Q ,\, b ,\, v ) {\bang} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 113\hspace{1em}}\@s{8.2} {\BY} SMT {\DEF}
 Ballot ,\, Send ,\, StructOK2}%
 \@x{\makebox[0pt][r]{\scriptsize 114\hspace{1em}}\@pfstepnum{1}{} . {\DEFINE}
 Q1b \.{\defeq} \{ m \.{\in} msgs\@s{2.10} \.{:} \.{\land} m [ 1 ]
 \.{=}\@w{1b}}%
 \@x{\makebox[0pt][r]{\scriptsize 115\hspace{1em}}\@s{148.46} \.{\land} m [ 2
 ] \.{\in} Q}%
 \@x{\makebox[0pt][r]{\scriptsize 116\hspace{1em}}\@s{148.46} \.{\land} m [ 3
 ] \.{=} b \}}%
 \@x{\makebox[0pt][r]{\scriptsize 117\hspace{1em}}\@pfstepnum{1}{} . {\DEFINE}
 Q1bv \.{\defeq} \{ m \.{\in} Q1b \.{:} m [ 4 ] \.{\geq} 0 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 118\hspace{1em}}\@pfstepnum{1}{3.}\  V
 {\bang} ShowsSafeAt ( Q ,\, b ,\, v ) {\bang} 2}%
 \@x{\makebox[0pt][r]{\scriptsize 119\hspace{1em}}\@s{8.2}\@pfstepnum{2}{1.}\ 
 {\SUFFICES} {\ASSUME} {\NEW} c \.{\in} \.{-} 1 \.{\dotdot} b \.{-} 1}%
 \@x{\makebox[0pt][r]{\scriptsize 120\hspace{1em}}\@s{76.37} {\PROVE}
 \.{\land} c \.{\neq} \.{-} 1 \.{\implies} ( \E\, a \.{\in} Q \.{:} V {\bang}
 VotedFor ( a ,\, c ,\, v ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 121\hspace{1em}}\@s{110.52} \.{\land} \A\, d
 \.{\in} c \.{+} 1 \.{\dotdot} b \.{-} 1 ,\, a \.{\in} Q \.{:} V {\bang}
 DidNotVoteAt ( a ,\, d )}%
\@x{\makebox[0pt][r]{\scriptsize 122\hspace{1em}}\@s{16.4} {\BY} SMT}%
 \@x{\makebox[0pt][r]{\scriptsize 123\hspace{1em}}\@s{8.2}\@pfstepnum{2}{2.}\ 
 c \.{\neq} \.{-} 1 \.{\implies} ( \E\, a \.{\in} Q \.{:} V {\bang} VotedFor
 ( a ,\, c ,\, v ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 124\hspace{1em}}\@s{8.2}\@pfstepnum{2}{3.}\ 
 \A\, d \.{\in} c \.{+} 1 \.{\dotdot} b \.{-} 1 ,\, a \.{\in} Q \.{:} V
 {\bang} DidNotVoteAt ( a ,\, d )}%
 \@x{\makebox[0pt][r]{\scriptsize 125\hspace{1em}}\@s{8.2}\@pfstepnum{2}{q.}\ 
 {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 126\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{2}{2} ,\,\@pfstepnum{2}{3} ,\, SMT}%
\@x{\makebox[0pt][r]{\scriptsize 127\hspace{1em}}\@pfstepnum{1}{q.}\  {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 128\hspace{1em}}\@s{8.2}
 {\BY}\@pfstepnum{1}{2} ,\,\@pfstepnum{1}{3} ,\, Z3 {\DEF} V {\bang}
 ShowsSafeAt}%
\@x{\makebox[0pt][r]{\scriptsize 129\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 130\hspace{1em}} {\THEOREM} Next \.{\land}
 Inv \.{\implies} V {\bang} Next \.{\lor} {\UNCHANGED} {\langle} votes ,\,
 maxBal {\rangle}}%
 \@x{\makebox[0pt][r]{\scriptsize 131\hspace{1em}}\@pfstepnum{1}{1.}\ 
 {\SUFFICES} {\ASSUME} Next ,\, Inv {\PROVE} V {\bang} Next}%
 \@x{\makebox[0pt][r]{\scriptsize 132\hspace{1em}}\@s{8.2}
 {\BY}\@pfstepnum{1}{1} ,\, SMT}%
 \@x{\makebox[0pt][r]{\scriptsize 133\hspace{1em}}\@pfstepnum{1}{} . {\USE}
 {\DEF} Next ,\, V {\bang} Next}%
 \@x{\makebox[0pt][r]{\scriptsize 134\hspace{1em}}\@pfstepnum{1}{2.} {\CASE}
 \E\, b\@s{0.64} \.{\in} Ballot \.{:} Phase1a ( b )}%
 \@x{\makebox[0pt][r]{\scriptsize 135\hspace{1em}}\@pfstepnum{1}{3.} {\CASE}
 \E\, b\@s{0.64} \.{\in} Ballot \.{:} \E\, v \.{\in} Value \.{:} Phase2a ( b
 ,\, v )}%
 \@x{\makebox[0pt][r]{\scriptsize 136\hspace{1em}}\@pfstepnum{1}{4.} {\CASE}
 \E\, a \.{\in} Acceptor \.{:} Phase1b ( a )}%
 \@x{\makebox[0pt][r]{\scriptsize 137\hspace{1em}}\@s{8.2}
 {\BY}\@pfstepnum{1}{4} ,\, Inv ,\, WFmsgs ,\, Z3T ( 10 )}%
 \@x{\makebox[0pt][r]{\scriptsize 138\hspace{1em}}\@s{8.2} {\DEF} Phase1b ,\,
 Inv ,\, WellFormedMessages ,\, Ballot ,\, V {\bang} Ballot ,\, V {\bang}
 IncreaseMaxBal ,\, votes ,\, Send}%
 \@x{\makebox[0pt][r]{\scriptsize 139\hspace{1em}}\@pfstepnum{1}{5.} {\CASE}
 \E\, a \.{\in} Acceptor \.{:} Phase2b ( a )}%
 \@x{\makebox[0pt][r]{\scriptsize 140\hspace{1em}}\@s{8.2}\@pfstepnum{2}{1.}\ 
 {\PICK} a \.{\in} Acceptor ,\, m \.{\in} msgs \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 141\hspace{1em}}\@s{48.48} \.{\land} m [ 1 ]
 \.{=}\@w{2a}}%
 \@x{\makebox[0pt][r]{\scriptsize 142\hspace{1em}}\@s{48.48} \.{\land} m [ 2 ]
 \.{\geq} maxBal [ a ]}%
