...
\setboolean{shading}{true}
 ...
 {\MODULE} EuclidEx}\moduleRightDash\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} GCD ,\, TLAPS}%
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} {\CONSTANTS} M ,\, N}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} {\ASSUME} MNPosInt
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 M \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}}\@s{16.4} \.{\land}\@s{10.73}
 N\@s{1.53} \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
\begin{lcom}{5.0}%
...
\pcalshadingtrue
\csyntaxtrue
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} {\p@mmalgorithm} Euclid
 {\p@lbrace}}%
 ...
 {\p@rbrace}}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{102.91}
 {\p@else}\@s{24.59} {\p@lbrace} x\@s{9.09} \.{:=} x \.{-} y {\p@rbrace}}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{93.33} {\p@rbrace}
 {\p@semicolon}}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{8.2} {\p@rbrace}}%
\@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} {\p@rbrace}}%
\@y{}%
\@xx{}%
...
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} {\VARIABLES} x ,\, y ,\, pc}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} vars \.{\defeq} {\langle} x
 ,\, y ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}}\@s{37.72} \.{\land} x \.{=}
 M}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}\@s{37.72} \.{\land}
 y\@s{0.10} \.{=} N}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}\@s{37.72} \.{\land} pc
 \.{=}\@w{Lbl\_1}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}} Lbl\_1 \.{\defeq} \.{\land}
 pc \.{=}\@w{Lbl\_1}}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{42.84} \.{\land} {\IF} x
 \.{\neq} y}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{66.11} \.{\THEN}
 \.{\land} {\IF} x \.{<} y}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{120.69} \.{\THEN}
 \.{\land} y \.{'}\@s{0.10} \.{=} y \.{-} x}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{152.00} \.{\land} x \.{'}
 \.{=} x}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{120.69} \.{\ELSE}
 \.{\land} x \.{'} \.{=} x \.{-} y}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{152.00} \.{\land} y
 \.{'}\@s{0.10} \.{=} y}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{97.42} \.{\land} pc \.{'}
 \.{=}\@w{Lbl\_1}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{66.11} \.{\ELSE}
 \.{\land} pc \.{'} \.{=}\@w{Done}}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{97.42} \.{\land}
 {\UNCHANGED} {\langle} x ,\, y {\rangle}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} Next \.{\defeq} Lbl\_1}%
\@y{\@s{0}%
 Allow infinite stuttering to prevent deadlock on termination.
}%
\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}}\@s{52.13} \.{\lor}\@s{0.54}
 ( pc \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}} Termination \.{\defeq}
 {\Diamond} ( pc \.{=}\@w{Done} )}%
\@pvspace{8.0pt}%
...
\@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}} PartialCorrectness
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4} ( pc \.{=}\@w{Done}
 ) \.{\implies} ( x \.{=} y ) \.{\land} ( x \.{=} GCD ( M ,\, N ) )}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}} TypeOK \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 x \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{16.4} \.{\land}\@s{9.74}
 y\@s{0.10} \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}} Inv \.{\defeq}}%
\@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{15.15} \.{\land} TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{15.15} \.{\land} GCD ( x
 ,\, y ) \.{=} GCD ( M ,\, N )}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{15.15} \.{\land} ( pc
 \.{=}\@w{Done} ) \.{\implies} ( x \.{=} y )}%
\@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}} {\THEOREM} Spec \.{\implies}
 {\Box} PartialCorrectness}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@pfstepnum{1}{1.}\  Init
 \.{\implies} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@s{8.2} {\BY} MNPosInt
 {\DEF} Init ,\, Inv ,\, TypeOK}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@pfstepnum{1}{2.}\  Inv
 \.{\land} [ Next ]_{ vars} \.{\implies} Inv \.{'}}%
 \@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}\@s{8.2} {\BY} MNPosInt ,\,
 GCD2 ,\, GCD3 {\DEF} Inv ,\, TypeOK ,\, Next ,\, Lbl\_1 ,\, vars}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}}\@pfstepnum{1}{3.}\  Inv
 \.{\implies} PartialCorrectness}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{8.2} {\BY} MNPosInt ,\,
 GCD1 {\DEF} Inv ,\, TypeOK ,\, PartialCorrectness}%
\@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@pfstepnum{1}{4.}\  {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{8.2}
 {\BY}\@pfstepnum{1}{1} ,\,\@pfstepnum{1}{2} ,\,\@pfstepnum{1}{3} ,\, PTL
 {\DEF} Spec}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 16 09:46:10 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Mon}
 \ensuremath{Jul} 15 16:59:12 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\end{lcom}%
\end{document}
