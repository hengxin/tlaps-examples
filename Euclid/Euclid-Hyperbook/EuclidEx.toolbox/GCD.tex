...
\setboolean{shading}{true}
 ...
 {\MODULE} GCD}\moduleRightDash\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 2\hspace{1em}} {\EXTENDS} Integers}%
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} Divides ( p ,\, n )\@s{3.88}
 \.{\defeq} \E\, q \.{\in} Int \.{:} n \.{=} p \.{*} q}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} DivisorsOf ( n ) \.{\defeq}
 \{ p \.{\in} Int\@s{14.89} \.{:} Divides ( p ,\, n ) \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} SetMax ( S )\@s{4.54}
 \.{\defeq} {\CHOOSE} i \.{\in} S \.{:} \A\, j \.{\in} S \.{:} i \.{\geq} j}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}} GCD ( m ,\, n ) \.{\defeq}
 SetMax ( DivisorsOf ( m ) \.{\cap} DivisorsOf ( n ) )}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} {\THEOREM} GCD1 \.{\defeq}
 \A\, m \.{\in} Nat \.{\,\backslash\,} \{ 0 \} \.{:} GCD ( m ,\, m ) \.{=} m}%
 \@x{\makebox[0pt][r]{\scriptsize 12\hspace{1em}}\@s{8.2}\@pfstepnum{1}{}\ 
 {\SUFFICES} {\ASSUME} {\NEW} m \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}}\@s{68.59} {\PROVE}\@s{4.1}
 GCD ( m ,\, m ) \.{=} m}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}\@s{24.31} {\OBVIOUS}}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}}\@s{8.2}\@pfstepnum{1}{1.}\ 
 Divides ( m ,\, m )}%
 \@x{\makebox[0pt][r]{\scriptsize 16\hspace{1em}}\@s{16.4} {\BY} {\DEF}
 Divides}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}\@s{8.2}\@pfstepnum{1}{2.}\ 
 \A\, i \.{\in} Nat \.{:} Divides ( i ,\, m ) \.{\implies} ( i \.{\leq} m )}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{16.4} {\BY} {\DEF}
 Divides}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{8.2}\@pfstepnum{1}{3.}\ 
 {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{1}{1} ,\,\@pfstepnum{1}{2}\  {\DEF} GCD ,\, SetMax ,\,
 DivisorsOf}%
\@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}} {\THEOREM} GCD2 \.{\defeq}
 \A\, m ,\, n \.{\in} Nat \.{\,\backslash\,} \{ 0 \} \.{:} GCD ( m ,\, n )
 \.{=} GCD ( n ,\, m )}%
\@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} {\BY} {\DEF} GCD}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} {\THEOREM} GCD3 \.{\defeq}
 \A\, m ,\, n \.{\in} Nat \.{\,\backslash\,} \{ 0 \} \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{110.25} ( n \.{>} m )
 \.{\implies} ( GCD ( m ,\, n ) \.{=} GCD ( m ,\, n \.{-} m ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{8.2}\@pfstepnum{1}{}\ 
 {\SUFFICES} {\ASSUME} {\NEW} m \.{\in} Nat \.{\,\backslash\,} \{ 0 \} ,\,
 {\NEW} n \.{\in} Nat \.{\,\backslash\,} \{ 0 \} ,\,}%
\@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}}\@s{106.84} n \.{>} m}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{68.59} {\PROVE}\@s{4.1}
 GCD ( m ,\, n ) \.{=} GCD ( m ,\, n \.{-} m )}%
\@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{16.4} {\OBVIOUS}}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{8.2}\@pfstepnum{1}{}\ 
 \A\, i \.{\in} Int \.{:}}%
 \@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}\@s{32.51} Divides ( i ,\, m
 ) \.{\land} Divides ( i ,\, n ) \.{\equiv} Divides ( i ,\, m ) \.{\land}
 Divides ( i ,\, n \.{-} m )}%
 \@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}}\@s{16.4} {\BY} {\DEF}
 Divides}%
 \@x{\makebox[0pt][r]{\scriptsize 34\hspace{1em}}\@s{8.2}\@pfstepnum{1}{}\ 
 {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}}\@s{16.4} {\BY} {\DEF} GCD
 ,\, SetMax ,\, DivisorsOf}%
