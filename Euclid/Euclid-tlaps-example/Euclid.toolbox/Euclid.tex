...
\@x{\makebox[0pt][r]{\scriptsize 3\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 4\hspace{1em}} p \.{\,|\,} q \.{\defeq} \E\,
 d \.{\in} 1 \.{\dotdot} q \.{:} q \.{=} p \.{*} d}%
 \@x{\makebox[0pt][r]{\scriptsize 5\hspace{1em}} Divisors ( q ) \.{\defeq} \{
 d \.{\in} 1 \.{\dotdot} q \.{:} d \.{\,|\,} q \}}%
 \@x{\makebox[0pt][r]{\scriptsize 6\hspace{1em}} Maximum ( S ) \.{\defeq}
 {\CHOOSE} x \.{\in} S \.{:} \A\, y \.{\in} S \.{:} x \.{\geq} y}%
 \@x{\makebox[0pt][r]{\scriptsize 7\hspace{1em}} GCD ( p ,\, q ) \.{\defeq}
 Maximum ( Divisors ( p ) \.{\cap} Divisors ( q ) )}%
 \@x{\makebox[0pt][r]{\scriptsize 8\hspace{1em}} Number \.{\defeq} Nat
 \.{\,\backslash\,} \{ 0 \}}%
\@x{\makebox[0pt][r]{\scriptsize 9\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} {\CONSTANTS} M ,\, N}%
\@x{\makebox[0pt][r]{\scriptsize 11\hspace{1em}} {\VARIABLES} x ,\, y}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 13\hspace{1em}} {\ASSUME} NumberAssumption
 \.{\defeq} M \.{\in} Number \.{\land} N \.{\in} Number}%
\@x{\makebox[0pt][r]{\scriptsize 14\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 15\hspace{1em}} Init\@s{4.12} \.{\defeq} ( x
 \.{=} M ) \.{\land} ( y \.{=} N )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}} Next \.{\defeq} \.{\lor}
 \.{\land} x \.{<} y}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}}\@s{50.94} \.{\land} y
 \.{'}\@s{0.10} \.{=} y \.{-} x}%
 \@x{\makebox[0pt][r]{\scriptsize 19\hspace{1em}}\@s{50.94} \.{\land} x \.{'}
 \.{=} x}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}}\@s{39.83} \.{\lor} \.{\land}
 y \.{<} x}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{50.94} \.{\land} x \.{'}
 \.{=} x \.{-} y}%
 \@x{\makebox[0pt][r]{\scriptsize 22\hspace{1em}}\@s{50.94} \.{\land} y
 \.{'}\@s{0.10} \.{=} y}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ {\langle} x ,\, y {\rangle}}}%
\@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}} ResultCorrect \.{\defeq} ( x
 \.{=} y ) \.{\implies} x \.{=} GCD ( M ,\, N )}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 28\hspace{1em}} InductiveInvariant
 \.{\defeq}}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}}\@s{8.2} \.{\land} x \.{\in}
 Number}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@s{8.2} \.{\land} y\@s{0.10}
 \.{\in} Number}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{8.2} \.{\land} GCD ( x
 ,\, y ) \.{=} GCD ( M ,\, N )}%
\@x{\makebox[0pt][r]{\scriptsize 32\hspace{1em}}}\midbar\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 33\hspace{1em}} {\USE} {\DEF} Number}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 35\hspace{1em}} {\THEOREM} InitProperty
 \.{\defeq} Init \.{\implies} InductiveInvariant}%
 \@x{\makebox[0pt][r]{\scriptsize 36\hspace{1em}}\@s{8.2} {\BY}
 NumberAssumption {\DEF} Init ,\, InductiveInvariant}%
\@x{\makebox[0pt][r]{\scriptsize 37\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 38\hspace{1em}} {\AXIOM} GCDProperty1
 \.{\defeq} \A\, p \.{\in} Number \.{:} GCD ( p ,\, p ) \.{=} p}%
 \@x{\makebox[0pt][r]{\scriptsize 39\hspace{1em}} {\AXIOM} GCDProperty2
 \.{\defeq} \A\, p ,\, q \.{\in} Number \.{:} GCD ( p ,\, q ) \.{=} GCD ( q
 ,\, p )}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}} {\AXIOM} GCDProperty3
 \.{\defeq} \A\, p ,\, q \.{\in} Number \.{:} ( p \.{<} q ) \.{\implies} GCD
 ( p ,\, q ) \.{=} GCD ( p ,\, q \.{-} p )}%
\@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}} {\THEOREM} NextProperty
 \.{\defeq} InductiveInvariant \.{\land} Next \.{\implies} InductiveInvariant
 \.{'}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@pfstepnum{1}{}\ 
 {\SUFFICES} {\ASSUME} InductiveInvariant ,\, Next}%
 \@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{60.39} {\PROVE}\@s{4.1}
 InductiveInvariant \.{'}}%
\@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{8.2} {\OBVIOUS}}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@pfstepnum{1}{}\  {\USE}
 {\DEF} InductiveInvariant ,\, Next}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@pfstepnum{1}{1.}\  ( x
 \.{<} y ) \.{\lor} ( y \.{<} x )}%
\@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{8.2} {\OBVIOUS}}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@pfstepnum{1}{a.} {\CASE} x
 \.{<} y}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{8.2}\@pfstepnum{2}{1.}\ 
 ( y \.{-} x \.{\in} Number ) \.{\land} {\lnot} ( y \.{<} x )}%
 \@x{\makebox[0pt][r]{\scriptsize 51\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{1}{a} ,\, SMT {\DEF} Number}%
 \@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@s{8.2}\@pfstepnum{2}{2.}\ 
 {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{1}{a} ,\,\@pfstepnum{2}{1} ,\, GCDProperty3}%
 \@x{\makebox[0pt][r]{\scriptsize 54\hspace{1em}}\@pfstepnum{1}{b.} {\CASE} y
 \.{<} x}%
 \@x{\makebox[0pt][r]{\scriptsize 55\hspace{1em}}\@s{8.2}\@pfstepnum{2}{1.}\ 
 ( x \.{-} y \.{\in} Number ) \.{\land} {\lnot} ( x \.{<} y )}%
 \@x{\makebox[0pt][r]{\scriptsize 56\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{1}{b} ,\, SMT {\DEF} Number}%
 \@x{\makebox[0pt][r]{\scriptsize 57\hspace{1em}}\@s{8.2}\@pfstepnum{2}{2.}\ 
 GCD ( y \.{'} ,\, x \.{'} ) \.{=} GCD ( y ,\, x )}%
 \@x{\makebox[0pt][r]{\scriptsize 58\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{1}{b} ,\,\@pfstepnum{2}{1} ,\, GCDProperty3}%
 \@x{\makebox[0pt][r]{\scriptsize 59\hspace{1em}}\@s{8.2}\@pfstepnum{2}{4.}\ 
 {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 60\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{1}{b} ,\,\@pfstepnum{2}{1} ,\,\@pfstepnum{2}{2} ,\,
 GCDProperty2}%
\@x{\makebox[0pt][r]{\scriptsize 61\hspace{1em}}\@pfstepnum{1}{}\  {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 62\hspace{1em}}\@s{8.2}
 {\BY}\@pfstepnum{1}{1} ,\,\@pfstepnum{1}{a} ,\,\@pfstepnum{1}{b}\ }%
\@x{\makebox[0pt][r]{\scriptsize 63\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 64\hspace{1em}} {\THEOREM} Correctness
 \.{\defeq} Spec \.{\implies} {\Box} ResultCorrect}%
 \@x{\makebox[0pt][r]{\scriptsize 65\hspace{1em}}\@s{8.2}\@pfstepnum{1}{1}\ 
 InductiveInvariant \.{\land} {\UNCHANGED} {\langle} x ,\, y {\rangle}
 \.{\implies} InductiveInvariant \.{'}}%
 \@x{\makebox[0pt][r]{\scriptsize 66\hspace{1em}}\@s{16.4} {\BY} {\DEF}
 InductiveInvariant}%
 \@x{\makebox[0pt][r]{\scriptsize 67\hspace{1em}}\@s{8.2}\@pfstepnum{1}{2}\ 
 Spec \.{\implies} {\Box} InductiveInvariant}%
 \@x{\makebox[0pt][r]{\scriptsize 68\hspace{1em}}\@s{16.4} {\BY} PTL ,\,
 InitProperty ,\, NextProperty ,\,\@pfstepnum{1}{1}\  {\DEF} Spec}%
 \@x{\makebox[0pt][r]{\scriptsize 69\hspace{1em}}\@s{8.2}\@pfstepnum{1}{3}\ 
 InductiveInvariant \.{\implies} ResultCorrect}%
 \@x{\makebox[0pt][r]{\scriptsize 70\hspace{1em}}\@s{16.4} {\BY} GCDProperty1
 {\DEF} InductiveInvariant ,\, ResultCorrect}%
 \@x{\makebox[0pt][r]{\scriptsize 71\hspace{1em}}\@s{8.2}\@pfstepnum{1}{}\ 
 {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 72\hspace{1em}}\@s{16.4} {\BY} PTL
 ,\,\@pfstepnum{1}{2} ,\,\@pfstepnum{1}{3}\ }%
