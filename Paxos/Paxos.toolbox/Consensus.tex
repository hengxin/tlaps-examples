...
This is a trivial specification of consensus. It asserts that the
 variable \ensuremath{chosen} , which represents the set of values that
 someone
...
\@x{\makebox[0pt][r]{\scriptsize 10\hspace{1em}} {\CONSTANTS} Values}%
\@y{\@s{0}%
...
\@x{\makebox[0pt][r]{\scriptsize 17\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 18\hspace{1em}} Init\@s{4.12} \.{\defeq}
 chosen \.{=} \{ \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 20\hspace{1em}} Next \.{\defeq} \.{\land}
 chosen \.{=} \{ \}}%
 \@x{\makebox[0pt][r]{\scriptsize 21\hspace{1em}}\@s{39.83} \.{\land} \E\, v
 \.{\in} Values \.{:} chosen \.{'} \.{=} \{ v \}}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 23\hspace{1em}} Spec\@s{1.46} \.{\defeq}
 Init \.{\land} {\Box} [ Next ]_{ chosen}}%
\@x{\makebox[0pt][r]{\scriptsize 24\hspace{1em}}}\midbar\@xx{}%
 \@x{\makebox[0pt][r]{\scriptsize 25\hspace{1em}} Inv \.{\defeq} Cardinality (
 chosen ) \.{\leq} 1}%
\@x{\makebox[0pt][r]{\scriptsize 26\hspace{1em}}\@s{15.15}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} TypeOK
}}%
\@xx{}%
\@x{\makebox[0pt][r]{\scriptsize 27\hspace{1em}}\@s{15.15}}%
\@y{\@s{0}%
 \ensuremath{\.{\land} Cardinality(chosen) \.{\leq} 1
}}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\makebox[0pt][r]{\scriptsize 29\hspace{1em}} {\THEOREM} Spec \.{\implies}
 {\Box} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 30\hspace{1em}}\@pfstepnum{1}{1.}\  Init
 \.{\implies} Inv}%
 \@x{\makebox[0pt][r]{\scriptsize 31\hspace{1em}}\@s{8.2} {\BY} {\DEF} Init
 ,\, Inv}%
\begin{lcom}{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\@pfstepnum{2}{}} \ensuremath{{\SUFFICES}} \ensuremath{{\ASSUME}}
 \ensuremath{Init
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{32.5}{0}{}%
\ensuremath{{\PROVE}} \ensuremath{Inv
}%
\end{cpar}%
...
\ensuremath{\@pfstepnum{2}{}} \ensuremath{{\QED}
}%
\end{cpar}%
\begin{cpar}{0}{T}{F}{5.0}{0}{}%
\ensuremath{{\BY}} \ensuremath{{\DEF}} \ensuremath{Init}, \ensuremath{Inv
}%
\end{cpar}%
\end{lcom}%
 \@x{\makebox[0pt][r]{\scriptsize 40\hspace{1em}}\@pfstepnum{1}{2.}\  Inv
 \.{\land} [ Next ]_{ chosen} \.{\implies} Inv \.{'}}%
 \@x{\makebox[0pt][r]{\scriptsize 41\hspace{1em}}\@s{8.2}\@pfstepnum{2}{}\ 
 {\SUFFICES} {\ASSUME} Inv ,\,}%
 \@x{\makebox[0pt][r]{\scriptsize 42\hspace{1em}}\@s{106.84} [ Next ]_{
 chosen}}%
 \@x{\makebox[0pt][r]{\scriptsize 43\hspace{1em}}\@s{68.59} {\PROVE}\@s{4.1}
 Inv \.{'}}%
\@x{\makebox[0pt][r]{\scriptsize 44\hspace{1em}}\@s{16.4} {\OBVIOUS}}%
 \@x{\makebox[0pt][r]{\scriptsize 45\hspace{1em}}\@s{8.2}\@pfstepnum{2}{1.}
 {\CASE} Next}%
 \@x{\makebox[0pt][r]{\scriptsize 46\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{2}{1}\  {\DEF} Inv ,\, Next}%
 \@x{\makebox[0pt][r]{\scriptsize 47\hspace{1em}}\@s{8.2}\@pfstepnum{2}{2.}
 {\CASE} {\UNCHANGED} chosen}%
 \@x{\makebox[0pt][r]{\scriptsize 48\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{2}{2}\  {\DEF} Inv ,\, Next}%
 \@x{\makebox[0pt][r]{\scriptsize 49\hspace{1em}}\@s{8.2}\@pfstepnum{2}{3.}\ 
 {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 50\hspace{1em}}\@s{16.4}
 {\BY}\@pfstepnum{2}{1} ,\,\@pfstepnum{2}{2}\ }%
\@pvspace{8.0pt}%
\@x{\makebox[0pt][r]{\scriptsize 52\hspace{1em}}\@pfstepnum{1}{3.}\  {\QED}}%
 \@x{\makebox[0pt][r]{\scriptsize 53\hspace{1em}}\@s{8.2}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jul} 16 13:47:23 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified \ensuremath{Tue}
 \ensuremath{Jul} 16 11:26:27 \ensuremath{CST} 2019 by \ensuremath{hengxin
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified \ensuremath{Wed}
 \ensuremath{Nov} 21 11:35:33 \ensuremath{PST} 2012 by \ensuremath{lamport
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Mon}
 \ensuremath{Nov} 19 15:19:09 \ensuremath{PST} 2012 by \ensuremath{lamport
}%
\end{cpar}%
\end{lcom}%
\end{document}
